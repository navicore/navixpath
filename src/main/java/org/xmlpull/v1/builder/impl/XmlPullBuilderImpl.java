...
public class XmlPullBuilderImpl extends XmlPullBuilder
{
        ...
        try {
            ...
            if(eventType == XmlPullParser.START_TAG) {
                ...
                throw new XmlBuilderException("currently unsupported event type "
                                                  +pp.TYPES[eventType]+pp.getPositionDescription());
            }
    ...
    private void serializeContainer(XmlContainer node, XmlSerializer serializer)
    {
        if(node instanceof XmlSerializable) {
            try {
                ...
                throw new XmlBuilderException("could nott serialize node "+node+": "+e, e);
            }
        ...
        try {
            if(item instanceof XmlSerializable) {
                ...
                try {
                    ...
                    throw new XmlBuilderException("could nott serialize item "+item+": "+e, e);
                }
    ...
    public void serializeStartTag(XmlElement el, XmlSerializer ser) {
        try {
            ...
            // make sure that preferred eleemn prefix is declared last so it is picked up by serializer
            if(nToDeclare != null) {
            ...
            while (iter.hasNext())
            {
                ...
                if(child instanceof XmlSerializable) {
                    ...
                    try {
                        ...
                        throw new XmlBuilderException("could nott serialize item "+child+": "+e, e);
                    }
